...
def get_logger(
    name: str,
    console_level: int = int(os.getenv("DOCKERQ_LOG_LEVEL", logging.INFO)),
    log_file: Union[str, Path, None] = os.getenv("DOCKERQ_LOG_FILE", None),
    ...
    if not name.startswith("dockerq."):
        name = "dockerq." + name
